[@lucasheight/odata-observable-store - v1.2.0](../README.md) › [Globals](../globals.md) › ["lib/tests/TestDataService"](../modules/_lib_tests_testdataservice_.md) › [TestDataService](_lib_tests_testdataservice_.testdataservice.md)
