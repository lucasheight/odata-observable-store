[@lucasheight/odata-observable-store](../README.md) › [Globals](../globals.md) › ["projects/odata-observable-store/src/lib/tests/testData"](_projects_odata_observable_store_src_lib_tests_testdata_.md)
